...
Most utility classes have a corresponding mixin with the same name. But remember, all classes have a mixin, but not every mixin has a class, there are mixins that can do a lot more. Utility classes are primarily for prototyping, or you can use them more extensively if you want.
